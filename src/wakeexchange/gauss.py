...
def add_gauss_params_IndepVarComps(openmdao_object):
    ...
    # openmdao_object.add('bp3', IndepVarComp('model_params:ky', 0.07, pass_by_object=True))
    # openmdao_object.add('bp4', IndepVarComp('model_params:kz', 0.07, pass_by_object=True))
    ...
    # openmdao_object.add('bp7', IndepVarComp('model_params:I', 0.01, pass_by_object=True))
