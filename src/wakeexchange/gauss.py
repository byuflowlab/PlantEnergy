...
def add_gauss_params_IndepVarComps(openmdao_object):
    ...
    openmdao_object.add('p1', IndepVarComp('model_params:rotation_offset_angle', val=1.56, units='deg',
                                           pass_by_object=True))
    openmdao_object.add('p2', IndepVarComp('model_params:spread_angle', val=5.84, units='deg', pass_by_object=True))
