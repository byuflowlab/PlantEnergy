...
class TestJensenWrapper(unittest.TestCase):
    ...
    def setUp(self):
        ...
        model_options = None
        prob = Problem(root=AEPGroup(nTurbs, nDirections, wake_model=jensen_wrapper, wake_model_options=model_options,
    ...
    def testImport(self):
        self.assertEqual(self.working_import, True, "jense_wrapper Import Failed")
